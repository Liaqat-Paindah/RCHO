    ...
    <div class="container aos-init aos-animate" data-aos="fade-up">
        ...
        <div class="row skills-content">
            ...
            <div class="col-lg-6">
                ...
                <div class="progress">
                    <span class="skill">Business transformation<i class="val">96%</i></span>
                ...
                <div class="progress">
                    <span class="skill"> Restructuring and turnaround <i class="val">90%</i></span>
                    <div class="progress-bar-wrap">
                ...
                <div class="progress">
                    <span class="skill">Integration <i class="val">95%</i></span>
                    <div class="progress-bar-wrap">
            ...
            <div class="col-lg-6">
                ...
                <div class="progress">
                    <span class="skill">Growth strategy<i class="val">95%</i></span>
                    <div class="progress-bar-wrap">
                        <div class="progress-bar" role="progressbar" aria-valuenow="95" aria-valuemin="0"
                ...
                <div class="progress">
                    <span class="skill">M&A transaction support <i class="val">90%</i></span>
                    <div class="progress-bar-wrap">
                        <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="0"
                ...
                <div class="progress">
                    <span class="skill">Business planning <i class="val">90%</i></span>
                    <div class="progress-bar-wrap">
                        <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="0"
                            aria-valuemax="100" style="width: 50%;"></div>
                    </div>
