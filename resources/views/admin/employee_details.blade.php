    ...
    <div class="col-xl-4">
      ...
      <div class="card">
        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
          ...
          <img src="assets/img/profile/liaqat.jpg" alt="Profile" class="rounded-circle">
          <h2>Liaqat Paindah</h2>
          <h3>Liaqat.Paindah@gmail.com</h3>
        </div>
      </div>
          ...
          <div class="tab-content pt-2">
            ...
            <div class="tab-pane fade show active profile-overview" id="profile-overview">
              ...
              <div class="row">
                ...
                <div class="col-lg-9 col-md-8">Liaqat Paindah</div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-9 col-md-8">+93(0) 702-079-812</div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-9 col-md-8">03-04-1996</div>
              </div>

              <div class="row">
                <div class="col-lg-3 col-md-4 label">Nationality</div>
                <div class="col-lg-9 col-md-8">Afghan</div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-9 col-md-8">May 05, 2024</div>
              </div>
              <div class="row">
                <div class="col-lg-3 col-md-4 label">Address</div>
                <div class="col-lg-9 col-md-8">13th district, Kabul.</div>
              </div>
